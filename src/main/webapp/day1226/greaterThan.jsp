...
list = SelectService2.getInstance().greaterThan(Integer.parseInt(sal));
...
<thead>
<tr>
<th colspan=4><c:out value="${param.sal}"/>보다 연봉이 큰 사원</th>
</tr>
...
<td><fmt:formatDate value="${ss.hiredate}" pattern="yyyy-MM-dd kk:mm"/></td>
