...
public class EmpDomain {
	...
	public String getEname() {
		System.out.println("JSP EL에서 ${ename}로 사용");
		return ename;
	}
	...
	public int getSal() {
		System.out.println("JSP EL에서 ${sal}로 사용");
		return sal;
	}
	...
	public int getComm() {
		System.out.println("JSP EL에서 ${comm}로 사용");
		return comm;
	}
	...
	public Date getHiredate() {
		System.out.println("JSP EL에서 ${hiredate}로 사용");
		return hiredate;
	}
